...
function analyzeDynamically(targetImage, dockerfileAnalysis, analysisOptions) {
    return Promise.all([
        ...
        return response_builder_1.buildResponse(res[0], res[1], dockerfileAnalysis, res[2], analysisOptions);
    });
}
function analyzeStatically(targetImage, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            return response_builder_1.buildResponse(runtime, analysis, dockerfileAnalysis, manifestFiles, staticAnalysisOptions);
        }
        catch (error) {
