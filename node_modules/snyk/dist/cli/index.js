    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (args.options.file && args.options.allProjects) {
                throw new unsupported_option_combination_error_1.UnsupportedOptionCombinationError(['file', 'all-projects']);
            }
            ...
            if (args.options.docker && args.options.allProjects) {
                throw new unsupported_option_combination_error_1.UnsupportedOptionCombinationError(['docker', 'all-projects']);
            }
